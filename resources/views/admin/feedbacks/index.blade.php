            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">All Feedbacks</h4>
                                        ...
                                        <tbody>
                                            @foreach ($feedbacks as $feedback)
                                                <tr data-id="1" style="cursor: pointer;">
                                                    <td data-field="id" style="width: 80px">{{ $feedback->id }}</td>
                                                    <td data-field="author">{{ $feedback->author }}</td>
                                                    <td data-field="body">{!! Str::limit($feedback->body, 50) !!}</td>
                                                    <td style="width: 100px">
                                                        <a href="{{ route('admin.feedbacks.edit', $feedback->id) }}"
