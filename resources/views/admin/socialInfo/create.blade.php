            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Create Social Information</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.socialInfo.index') }}">Social
                                        Information</a></li>
                                <li class="breadcrumb-item active">Social Information create</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.socialInfo.store') }}" method="POST">
                                @csrf
                                <div class="mb-3">
