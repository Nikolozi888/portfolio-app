            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Footer Contact Us Information</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.contactInfo.index') }}">Contact Us
                                        Information</a></li>
                                <li class="breadcrumb-item active">Contact Us Info</li>
                            </ol>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                        ...
                                        <tbody>
                                            @foreach ($infos as $info)
                                                <tr data-id="1" style="cursor: pointer;">
                                                    ...
                                                    <td data-field="title">{{ $info->number }}</td>
                                                    <td data-field="description">{{ Str::limit($info->description, 50) }}</td>
                                                    <td style="width: 100px">
                                                        <a href="{{ route('admin.contactInfo.edit', $info->id) }}"
                                                            class="btn btn-outline-secondary btn-lg edit" title="Edit">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>
                                                        <form action="{{ route('admin.contactInfo.destroy', $info->id) }}"
                                ...
                                @else
                                    <h1>Not Contact Us Information</h1>
                                @endif
                            </div>
                        </div>
                    </div>
