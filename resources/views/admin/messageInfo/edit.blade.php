            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Contact Form Information</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.messageInfo.index') }}">Contact Form
                                        Information</a></li>
                                <li class="breadcrumb-item active">Contact Form edit</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.messageInfo.update', $info->id) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                <div class="mb-3">
